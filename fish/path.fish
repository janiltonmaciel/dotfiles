...
append-to-path /usr/local/opt/openssl/bin
...
set -gx WORKON_HOME $VIRTUALENVWRAPPER_HOOK_DIR
append-to-path $HOME/.poetry/bin

##### OLD ########
# MySQL
append-to-path /usr/local/opt/mysql-client/bin
